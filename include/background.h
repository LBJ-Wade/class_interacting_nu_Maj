...
struct background
{
  ...
  double * Gamma_eff_ncdmphi;            /**<VP: vector of effective interaction rate with the majoron, one per neutrino type*/
  double * Gamma_phi;                    /**<VP: vector of majoron decay width, one per neutrino type*/
  double M_phi;                          /**<VP: mass of the majoron */
  int entry_is_M_phi;                    /**<VP: entry corresponding to the majoron in the ncdm tables*/
  ...
  int * ncdm_background_distribution; /**< list of possible background ncdm distribution: 0 = fermi_dirac, 1 = _fermi_dirac_v2_ (ours), 2 = majoron */
...
//@}
 ...
 #define _fermi_dirac_v2_ 1 /**< integer associated to fermi_dirac_v2 distribution for ncdm species */
 #define _majoron_ 2 /**< integer associated to majoron (bose-einstein) distribution for ncdm species  */
/**
